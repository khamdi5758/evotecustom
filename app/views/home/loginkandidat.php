...
<body>
    ...
    <div class="kotak_login">
        ...
        <form action="<?= baseurl; ?>/auth/prosloginkandidat" method="post">
        ...
        <p>
            kembali login pemilih klik <a href="<?= baseurl; ?>/auth">disini</a>, untuk login panitia klik <a href="<?= baseurl; ?>/auth/loginpanitia">disini</a>, kembali ke home klik <a href="<?= baseurl; ?>">disini</a>
        </p>
    </div>
</body>
