...
<body>
    ...
    <div class="kotak_login">
        ...
        <form action="<?= baseurl; ?>/auth/prosloginpemilih" method="post">
        ...
        <p>untuk login kandidat klik <a href="<?= baseurl; ?>/auth/loginkandidat">disini</a>, untuk login panitia klik <a href="<?= baseurl; ?>/auth/loginpanitia">disini</a>, kembali ke home klik <a href="<?= baseurl; ?>">disini</a>
        </p>
    </div>
</body>
