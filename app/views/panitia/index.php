                                ...
                                <tbody>
                                    ...
                                    foreach ($data['panitia'] as $panitia) : ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?= $panitia['password']; ?></td>
                                            <td><?= $panitia['Keterangan']; ?></td>
                                            <td>
                                                <a href="<?= baseurl; ?>/panitia/edit/<?= $panitia['id_panitia']; ?>" class="btn btn-warning" style="margin-bottom: 20px;">ubah</a>
                                                <a href="<?= baseurl; ?>/panitia/delete/<?= $panitia['id_panitia']; ?>" class="btn btn-danger" style="margin-bottom: 20px;" onclick="return confirm('yakin')">hapus</a>
                                            </td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="judul">tambah data panitia</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="<?= baseurl; ?>/panitia/tambah" method="POST">
